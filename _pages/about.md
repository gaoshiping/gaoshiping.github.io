...
- **Unleashing Implicit Rewards: Prefix-Value Learning for Distribution-Level Optimization.** ICML 2026.
- **Discriminative Policy Optimization for Token-Level Reward Models.** ICML 2025.
- **Advantage-Guided Distillation for Preference Alignment in Small Language Models.** ICLR 2025 Spotlight.
- **Edit-Wise Preference Optimization for Grammatical Error Correction.** COLING 2025.
- **Self-Evolution Fine-Tuning for Policy Optimization.** Findings of EMNLP 2024.
- **A Novel Dynamic Interpolation Method Based on Temporal and Spatial Correlations.** Applied Intelligence, 2022.

Contact
======

I can be reached at [shiping@umich.edu](mailto:shiping@umich.edu) or [rungao2001@outlook.com](mailto:rungao2001@outlook.com).
